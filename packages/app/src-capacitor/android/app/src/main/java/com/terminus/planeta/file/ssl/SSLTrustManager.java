...
public final class SSLTrustManager {
    ...
    private Map<Account, SecureX509TrustManager> managers = new HashMap<>();

    private Map<Account, SSLSocketFactory> cachedFactories = new HashMap<>();
    ...
    private class SecureX509TrustManager implements X509TrustManager {
        ...
        private volatile List<X509Certificate> certsChain = Collections.unmodifiableList(new ArrayList<>());
        ...
        private void customCheck(List<X509Certificate> chain, String authType)
            ...
            certsChain = Collections.unmodifiableList(chain);
