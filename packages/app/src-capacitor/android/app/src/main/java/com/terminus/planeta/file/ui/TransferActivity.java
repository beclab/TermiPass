...
import com.terminus.planeta.file.notification.BaseNotificationProvider;
...
public class TransferActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TransferTabsAdapter tabsAdapter = new TransferTabsAdapter(getSupportFragmentManager());
