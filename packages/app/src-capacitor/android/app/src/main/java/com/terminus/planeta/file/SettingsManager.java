...
public final class SettingsManager {
    ...
    private SettingsManager() {
        if (VaultApp.Companion.getApplication() != null) {
            settingsSharedPref = PreferenceManager.getDefaultSharedPreferences(VaultApp.Companion.getApplication());
            sharedPref = VaultApp.Companion.getApplication().getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
    ...
    public boolean isGestureLockRequired() {
        ...
        LockPatternUtils mLockPatternUtils = new LockPatternUtils(VaultApp.Companion.getApplication());
