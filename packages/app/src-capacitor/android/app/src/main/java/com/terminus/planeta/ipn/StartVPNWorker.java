...
public final class StartVPNWorker extends Worker {
    ...
    @Override public Result doWork() {
        ...
        if (intent == null) {
            ...
            android.util.Log.e("StartVPNWorker", "TermiPass doesn't have permission from the system to start VPN. Launching the intent provided.");
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                notification = new Notification.Builder(app, channelId)
                        .setContentTitle("TermiPass Connection Failed")
