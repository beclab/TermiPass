...
public class TransferService extends Service {
     ...
     *
     * Note: when deleting all tasks whose state is {@link com.terminus.planeta.file.transfer.TaskState#TRANSFERRING} in the queue,
     * other tasks left will never be executed, because they are all in the {@link com.terminus.planeta.file.transfer.TaskState#INIT} state.
