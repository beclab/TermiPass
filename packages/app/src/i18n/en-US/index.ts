...
export default {
	...
	scan_qr_code_to_activate_new_terminus:
		'Scan the QR code to activate new Terminus',
	...
	file: 'Files',
	setting: 'Setting',
	welcome_introduce: 'Let people own their data again',
	next: 'Next',
	let_us_go: "Let's go",
	//setUnlock
	password: 'Password',
	...
	reset: 'Reset',
	two_passwords_inconsistent: '·The passwords entered do not match.',
	...
	//setupSuccess
	set_up_account: 'Set up an account',
	choose_setting_method: 'Choose a setting method',
	import_account: 'Import Account',
	create_account: 'Create Account',
	//unlock
	login: 'Login',
	unlock_account: 'Enter the password to login to your Account',
	//createDID
	create_desc:
		'Click Create to generate a TermiPass account with the following information as the id',
	wait_did_generate: 'Please wait did generate',
	create: 'Create',
	//import
	mnemonics: 'Mnemonic Phrase',
	mnemonic: 'Mnemonic Phrase',
	skip: 'Skip',
	paste: 'Paste',
	copy: 'Copy',
	terminus_username: 'Terminus Username',
	login_terminusOS: 'Enter the password to login to your TerminusOS',
	submit: 'Submit',
	confirm: 'Confirm',
	cancel: 'Cancel',
	//scan
	...
	favicons: 'Favicon',
	display: 'Display',
	enable_favicons: 'Enable Favicon',
	masked_fields: 'Masked Fields',
	reveal_on_hover: 'Reveal On Hover',
	masked_fields_desc:
	...
	after: 'After',
	min: 'Min',
	unlock_by_biometric: 'Unlock By Biometric',
	version: 'Version',
	language: 'Language',
	network: 'Network',
	...
	disconnect_all_warning_content:
	...
	//home
	select_terminus_name: 'Select terminus name',
	...
	search: 'Search',
	user_not_found: 'Sorry, this user was not found.',
	profile: 'Profile',
	be_patient: 'Sent, please be patient.',
	...
	no_message: 'No message,you can go to the address book to contact friends',
	no_friends: 'No friends yet, you can add friends by searching DID',
	add_vc: 'Add VC',
	add_vc_desc:
		'After adding vc and binding Terminus, you can use the full function of Secret',
	select: 'Select',
	select_terminus_name_account: 'Select terminus name account',
	wait_for_terminus_to_activate:
		'Wait for the DNS configuration to be completed',
	bind_terminus: 'Bind terminus',
	switch_accounts: 'Switch Account',
	logged_in: 'Logged in',
	request_user: 'request user',
	add_new_terminus_name: 'Add a new account',
	current_account_had_been_selected: 'The current account had been Selected',

	//item
	terminus_authenticator: 'Terminus Authenticator',
	delete_vault_item: 'Delete vault item',
	...
	desc_this_board:
		'Describe this board, example: monitor AI industry trends, Discover, etc.',
	info: 'Info',
	bookmark_current_page: 'Bookmark current page',
	rss_on_the_current_site: 'RSS on the current site',
	terminus_rss_for_the_current_page: 'TerminusRss for the current page',
	website_for_the_current_page: 'Website for the current page',
	no_info_data: 'No info data',
	...
	settings: {
		...
		brandingHelp:
			'You can customize how your File Browser instance looks and feels by changing its name, replacing the logo, adding custom styles and even disable external links to GitHub.\nFor more information about custom branding, please check out the {0}.',
		changePassword: 'Change Password',
		commandRunner: 'Command runner',
		commandRunnerHelp:
			'Here you can set commands that are executed in the named events. You must write one per line. The environment variables {0} and {1} will be available, being {0} relative to {1}. For more information about this feature and the available environment variables, please read the {2}.',
		...
		globalRules:
			"This is a global set of allow and disallow rules. They apply to every user. You can define specific rules on each user's settings to override this ones.",
		...
		userCommandsHelp:
			'A space separated list with the available commands for this user. Example:\n',
...
If you want to create an organization, please refer to the steps listed in the Terminus documentation.",
	...
	i_got_it: 'Got it',
	back: 'Back',
	request_domain_name_on_blockchain: 'Confirm',
	name: 'Name',
	value: 'Value',
  ...
  should be rotated as soon as possible.",
	...
	do_not_have_any_groups_yet: "Don't have any groups yet.",
	dashboard: 'Dashboard',
	new_vault: 'New Vault',
	invites: 'Invites',
	no_data: 'No Data.',
	...
	enter_the_6_digit_code_sent_to_code: 'Enter the 6-digit code sent to {code}',
